...
const possibleCard: CardObject[] = [
  ...
  { path: '/common/25.png', name: 'โล่ในตำนาน 🛡️', score: 80, description: 'ได้รับ +80 คะแนน!', id: 25 },
  { path: '/common/12.png', name: 'ยาเพิ่มพลัง 🧪', score: 80, description: 'ได้รับ +80 คะแนน!', id: 12 },
  { path: '/common/20.png', name: 'แผนที่สมบัติ 🗺️', score: 60, description: 'ได้รับ +60 คะแนน!', id: 20 },
  { path: '/common/40.png', name: 'ทอง 100G 💰', score: 100, description: 'ได้รับ +100 คะแนน!', id: 40 }
];
...
const GameScene: React.FC<GameSceneProps> = ({ navigate, start, setStart, addCard, foundItems, setFoundItems, score }: GameSceneProps) => {
  ...
  useEffect(() => {
    const hiddenItemsData: HiddenItem[] = [
      { id: 15, top: 700, left: 580, image_path: '/backdoterm.png', item_type: 'normal', width: 60, height: 60 },
      { id: 16, top: 740, left: 680, image_path: '/backdoterm.png', item_type: 'normal', width: 60, height: 60 },
      { id: 17, top: 680, left: 900, image_path: '/backdoterm.png', item_type: 'normal', width: 60, height: 60 },
      { id: 18, top: 800, left: 550, image_path: '/backdoterm.png', item_type: 'normal', width: 60, height: 60 },
      // { id: 5, top: 288, left: 80, image_path: '/book.png', item_type: 'normal', width: 60, height: 60 },
  ...
  useEffect(() => {
    const arrowElement : arrowElement[] = [
     ...
     { navigate: { navigate_func: navigate, navigate_to: 6 }, custom_image: "/arrow2.png",  rotation: { x:0, y:0 },  width : 50, height :50, top: 600, left: 480 },
