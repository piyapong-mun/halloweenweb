...
const possibleCard: CardObject[] = [
  ...
  { path: '/common/38.png', name: 'แผนที่สมบัติ 🗺️', score: 60, description: 'ได้รับ +60 คะแนน!', id: 38 },
  { path: '/common/25.png', name: 'ทอง 100G 💰', score: 100, description: 'ได้รับ +100 คะแนน!', id: 25 }
];
...
const GameScene: React.FC<GameSceneProps> = ({ navigate, start, setStart, hiddenPath, addCard, foundItems, setFoundItems, score   }: GameSceneProps) => {
  ...
  useEffect(() => {
    const hiddenItemsData: HiddenItem[] = [
      { id: 24, top: 740, left: 320, image_path: '/backdoterm.png', item_type: 'normal', width: 60, height: 60 },
      { id: 25, top: 280, left: 780, image_path: '/backdoterm.png', item_type: 'normal', width: 60, height: 60 },
      { id: 26, top: 720, left: 680, image_path: '/backdoterm.png', item_type: 'normal', width: 60, height: 60 },
      { id: 27, top: 650, left: 480, image_path: '/backdoterm.png', item_type: 'normal', width: 60, height: 60 },
      { id: 28, top: 288, left: 80, image_path: '/backdoterm.png', item_type: 'normal', width: 60, height: 60 },
  ...
  useEffect(() => {
    ...
    const arrowElement : arrowElement[] = [
     ...
     { navigate: { navigate_func: navigate, navigate_to: 4 }, custom_image: "/leftuparrow.png",  rotation: { x:0, y:0 },  width : 50, height :50, top: 850, left: 180 },
     { navigate: { navigate_func: navigate, navigate_to: 5 }, custom_image: "/rightuparrow.png",  rotation: { x:0, y:0 },  width : 50, height :50, top: 850, left: 800 },
