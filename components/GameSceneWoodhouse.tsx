...
const GameScene: React.FC<GameSceneProps> = ({ navigate, start, setStart, addCard, foundItems, setFoundItems, score }: GameSceneProps) => {
  ...
  useEffect(() => {
    const hiddenItemsData: HiddenItem[] = [
      { id: 19, top: 700, left: 450, image_path: '/backdoterm.png', item_type: 'normal', width: 60, height: 60 },
      { id: 20, top: 350, left: 460, image_path: '/backdoterm.png', item_type: 'normal', width: 60, height: 60 },
      { id: 21, top: 80, left: 680, image_path: '/backdoterm.png', item_type: 'normal', width: 60, height: 60 },
      { id: 22, top: 700, left: 100, image_path: '/backdoterm.png', item_type: 'normal', width: 60, height: 60 },
      { id: 23, top: 700, left: 800, image_path: '/backdoterm.png', item_type: 'normal', width: 60, height: 60 },
  ...
  useEffect(() => {
    const arrowElement : arrowElement[] = [
     { navigate: { navigate_func: navigate, navigate_to: 3 }, custom_image: "/backarrow.png",  rotation: { x:0, y:0 },  width : 50, height :50, top: 950, left: 470 },
