...
{ path: '/common/43.png', name: 'ทอง 100G 💰', score: 100, description: 'ได้รับ +100 คะแนน!', id: 43 }
];
...
const GameScene: React.FC<GameSceneProps> = ({ navigate, start, setStart, addCard, foundItems, setFoundItems, score, finishgame }: GameSceneProps) => {
  ...
  useEffect(() => {
    const hiddenItemsData: HiddenItem[] = [
      { id: 34, top: 700, left: 450, image_path: '/backdoterm.png', item_type: 'normal', width: 20, height: 20 },
      { id: 35, top: 600, left: 460, image_path: '/backdoterm.png', item_type: 'normal', width: 20, height: 20 },
      { id: 36, top: 550, left: 680, image_path: '/backdoterm.png', item_type: 'normal', width: 20, height: 20 },
      { id: 37, top: 700, left: 100, image_path: '/backdoterm.png', item_type: 'normal', width: 20, height: 20 },
      { id: 38, top: 700, left: 800, image_path: '/backdoterm.png', item_type: 'normal', width: 20, height: 20 },
      { id: 39, top: 940, left: 150, image_path: '/backdoterm.png', item_type: 'special', width: 20, height: 20 },
      ...
      <>
        {!start && (<div style={{
          ...
          <div style={{
            ...
            <Image src="/zombiermbg.png" alt="book" width={120} height={120} />
          </div>
          <div
            style={{
              width: '100%',
            ...
            <div style={{ marginLeft: '10px' }}>
              {/* <h1></h1> */}
              <p>ขอต้อนรับผู้สะสมสู่โรงพยาบาลร้างนะสถานที่นี้เป็นที่อยู่ของผู้ที่ติดเชื้อไวรัสที่ซ่อนตัวอยู่ขอให้คุณพบเจอกับผู้ติดเชื้อ</p>
            </div>
            <button style={{
              width: '25%',
              alignSelf: "flex-end",
