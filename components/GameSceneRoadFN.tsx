...
{ path: '/common/44.png', name: 'ทอง 100G 💰', score: 100, description: 'ได้รับ +100 คะแนน!', id: 44 }
];
...
const GameScene: React.FC<GameSceneProps> = ({ navigate, start, setStart, addCard, foundItems, setFoundItems, score, finishgame }: GameSceneProps) => {
  ...
  useEffect(() => {
    const hiddenItemsData: HiddenItem[] = [
      // { id: 46, top: 700, left: 450, image_path: '/backdoterm.png', item_type: 'normal', width: 60, height: 60 },
      // { id: 47, top: 600, left: 460, image_path: '/backdoterm.png', item_type: 'normal', width: 60, height: 60 },
      // { id: 48, top: 80, left: 680, image_path: '/backdoterm.png', item_type: 'normal', width: 60, height: 60 },
      // { id: 49, top: 700, left: 100, image_path: '/backdoterm.png', item_type: 'normal', width: 60, height: 60 },
      // { id: 50, top: 700, left: 800, image_path: '/backdoterm.png', item_type: 'normal', width: 60, height: 60 },
      // { id: 51, top: 650, left: 50, image_path: '/backdoterm.png', item_type: 'special', width: 60, height: 60 },
      ...
      <>
        {!start && (<div style={{
          ...
          <div style={{
            ...
            {/* <Image src="/ozAdminrmbg.png" alt="book" width={120} height={120} /> */}
          </div>
          <div
            style={{
              width: '100%',
            ...
            <div style={{ marginLeft: '10px' }}>
              {/* <h1></h1> */}
              <p>ยินดีต้อนรับสู่ถนนแห่งลูปนิรันดร์เส้นทางที่ไม่มีวันสิ้นสุด
ทุกย่างก้าวของเจ้าจะพาเจ้ากลับมายังที่เดิมเหมือนฝันที่ซ้ำซ้อนครั้งแล้วครั้งเล่าเจ้าคงกำลังมองหาการ์ดพิเศษอยู่สินะเสียใจด้วยที่นี่ไม่มีสิ่งใดให้เจ้าอีกแล้ว...</p>
            </div>
            <button style={{
              width: '25%',
              alignSelf: "flex-end",
        ...
        {lastReward && (
          <div style={{
            ...
            <BookCard path={lastReward.path} name={lastReward.name} description={lastReward.description} />
          </div>
        )}
        <div style={{
