        ...
        {!start && (<div style={{
          ...
          <div
            ...
            <div style={{ marginLeft: '10px' }}>
              {/* <h1></h1> */}
              <p>ยินดีด้วย...เจ้ารับเส้นทางแห่งจุดจบของโบสถ์ร้างนี้แล้ว ภายในสถานที่ศักดิ์สิทธิ์ที่ถูกลืมเลือน มีการ์ดระดับพิเศษซ่อนอยู่ ขอให้เจ้าโชคดี...เพราะแม่ชีน่ะ รู้จักซ่อนวิญญาณของตนได้แนบเนียนที่สุด</p>
            </div>
            <button style={{
              width: '25%',
              alignSelf: "flex-end",
