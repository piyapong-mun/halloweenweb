...
const GameScene: React.FC<GameSceneProps> = ({ navigate, start, setStart, addCard, foundItems, setFoundItems, score }: GameSceneProps) => {
  ...
  useEffect(() => {
    const hiddenItemsData: HiddenItem[] = [
      { id: 40, top: 700, left: 450, image_path: '/book.png', item_type: 'normal', width: 60, height: 60 },
      { id: 41, top: 350, left: 460, image_path: '/book.png', item_type: 'normal', width: 60, height: 60 },
      { id: 42, top: 80, left: 680, image_path: '/book.png', item_type: 'normal', width: 60, height: 60 },
      { id: 43, top: 700, left: 100, image_path: '/book.png', item_type: 'normal', width: 60, height: 60 },
      { id: 44, top: 700, left: 800, image_path: '/book.png', item_type: 'normal', width: 60, height: 60 },
      { id: 45, top: 780, left: 740, image_path: '/book.png', item_type: 'special', width: 60, height: 60 },
